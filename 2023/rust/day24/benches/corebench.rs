...
pub fn parse(c: &mut Criterion) {
    let contents: &str = include_str!("../../inputs/day24.txt");
    let mut group = c.benchmark_group("day24.parse.nosum.realinput");
...
pub fn part1(c: &mut Criterion) {
    let contents: &str = include_str!("../../inputs/day24.txt");
    let mut group = c.benchmark_group("day24.part1.realinput");
...
pub fn part2(c: &mut Criterion) {
    let contents: &str = include_str!("../../inputs/day24.txt");
    let mut group = c.benchmark_group("day24.part2.realinput");
