...
pub fn parse(c: &mut Criterion) {
    ...
    let mut group = c.benchmark_group("day21.parse.nosum.realinput");
...
pub fn part1(c: &mut Criterion) {
    let contents: &str = include_str!("../../inputs/day21.txt");
    let mut group = c.benchmark_group("day21.part1.realinput");
...
pub fn part2(c: &mut Criterion) {
    let contents: &str = include_str!("../../inputs/day21.txt");
    let mut group = c.benchmark_group("day21.part2.realinput");
